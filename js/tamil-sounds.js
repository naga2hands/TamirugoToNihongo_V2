...
const stages = [
  {
    ...
    தமிழ் எழுத்துகளை தொல்காப்பியர் நன்கு பகுத்து அறிந்து ஆய்ந்து விளக்கியிருக்கிறார். தமிழ் மொழியின் இலக்கணவாதி என்பதை விடவும், மொழியியலாளர் என்பதே அவருக்கு பொருத்தப்பெயராக இருக்கும். தமிழ் நிலப்பரப்பில் பரந்துவிரிந்து இருந்த மொழியியல் சிந்தனையின் நீட்சி இவர் எனலாம், அவ்வழியில் உங்களை தமிழின் எழுத்துக்கள் வழியே யப்பானிய மொழியின் அடிப்படை ஒலிகளுக்கு அழைத்துச்செல்வதே இக்கருவியின் நோக்கம். யப்பானிய வரி வடிவங்களை அடுத்தடுத்து கற்கலாம்.\n
    தமிழின் உயிர் 12, மெய் 18 சேர்ந்த 30 எழுத்துகளை முதல் எழுத்து என்கிறோம், உயிரும் மெய்யும் இணைந்து பிறக்கும் 216 எழுத்துகளை உயிர்மெய் என்கிறோம், 'ஃ' எனும் ஆய்தம்/தனியெழுத்துச் சேர்த்து மொத்த எழுத்துகள் 247 ஆகின்றது (12+18+216+1=247). அவற்றைத்தான் இங்கே பார்க்கிறீர்கள்.`,
...

  {
    label: 'நெடில் ஒலிகள்',
    note: `<b>    அ இ உ ஏ ஒ </b>
    மேல் உள்ள 5 உயிர் எழுத்துகளும் குறில் எனப்படும். இவற்றை உச்சரிக்கும் கால அளவு ஒரு மாத்திரையாகும். "மாத்திரை" என்பது கை நொடிப்பொழுது அல்லது கண் இமைப்பொழுது எனக் கூறலாம். யப்பானிய மொழியில் மாத்திரையை "மொர" என்பர்.\n
    <b>ஆ ஈ ஊ ஏ ஐ ஓ ஔ</b>
    மேல் உள்ள 7 உயிர் எழுத்துகளும் நெடில் எனப்படும். இவற்றை உச்சரிக்க இரண்டு மாத்திரை அளவு ஆகும்.\n
    ...
    அதாவது இது, 'கா' என்பதை 'கஅ' என்றும், 'கை' என்பதை 'கஇ' என்றும் எழுதிப் படிப்பதைப்போன்றது, தமிழும் யப்பானியமும் காலப்போக்கில் இவ்வாறான வெவ்வேறு வழியைத் தேர்வு செய்துள்ளன.`,
    summary: 'படிநிலை-2: நெடில்கள் தேவையா?',
  },

  {
    label: 'நெடில் ஒலிகள் நீக்கம்',
    note: `    நெடில்களை குறில்களைக் கொண்டே எழுதமுடிவதால், இந்த அட்டவணையிலிருந்து நெடில்கள் முற்றிலுமாக நீக்கப்பட்டுவிட்டன.\n
    கவனத்தில் கொள்ளுங்கள் நெடில்களின் வரிவடிவம்தான் இங்கிருந்து நீக்கப்பட்டுவிட்டன, ஆனால் தமிழ் மொழி போலவே யப்பானிய மொழியிலும் நெடில்கள் இருக்கின்றன அவற்றை எழுதும் முறைதான் வேறு. இது குறித்து பின்னர் விரிவாகப் பார்க்கலாம்.\n
    இப்போது, நீங்கள் "அ இ உ எ ஒ" என்பதை மனப்பாடம் செய்துபாருங்கள், தமிழைக்காட்டிலும் எளிமை தானே? இனி க-வரிசையின் "க கி கு கெ கொ" வெல்லாம் தன்னியல்பாக வந்துவிடும். யப்பானிய குழந்தைகள் இப்படிதான் ஆரம்பிக்கின்றனர்.`,
    summary: 'படிநிலை-3: நெடில்கள் நீக்கம்.',
  },

  {
    label: 'இல்லா உயிர்மெய் வரிகள்',
    note: `    யப்பானிய மொழியில் சில உயிர் மெய் வரிசைகள் கிடையாது அவற்றைப் பற்றி மிகச்சுருக்கமாக கீழே:\n
    <b>ங், ஞ் வரிசை: </b>
    இந்த 'ங்', 'ஞ்' வரிசையிலுள்ள ஒலிகளை முதலாகக்கொண்டு எந்தச் சொல்லும் யப்பானிய மொழியில் இல்லை, இவை சொல்லின் இடையில் வரும்போது 'ன்' என்ற எழுத்தைக் கொண்டே யப்பானியர்கள் எழுதுவர். 'தங்கம்' என்பதை 'தன்கம்' என்றும், 'மஞ்சள்' என்பதை 'மன்சள்' என்றும் எழுதுவதைப் போல.\n
    <b>ட், ண் வரிசை: </b>
    இந்த 'ட்', 'ண்' வரிசையிலுள்ள எந்த ஒலிகளைக்கொண்டும் யப்பானிய மொழியில் சொற்களே இல்லை.\n
    <b>ல் வரிசை: </b>
    யப்பானிய மொழியில் 'ல்' ஒலி இல்லை என்பர் சிலர், ஆனால் உண்மையில், 'ல்' மற்றும் 'ர்' இணைந்த ஒலிதான் இந்த 'ர்' வரிசையில் உள்ளது. எனவே, 'ல்'ற்கென்று தனி வரிசை கிடையாது.  "ராமென்" என்று யப்பானியர் உச்சரிக்கையில் சிலசமயம் "லாமென்" என்று கேட்பதன் காரணம் இதுவே.\n
    <b>ழ், ள், ற் வரிசை: </b>
    ஏற்கனவே 'ல்', 'ர்' இணைந்து 'ர்' ஆக இருப்பதால், இந்த 'ழ்', 'ள்', 'ற்' வரிசைகள் யப்பானிய மொழியில் இல்லாமல் இருக்கிறது.\n`,
    summary: 'படிநிலை-4: எல்லா உயிர்மெய் வரிசையும் தேவையா?.',
  },

  {
    label: 'அடிப்படை வரிசைகள்',
    note: `    தேவையற்ற உயிர் நெடில்கள் மற்றும் உயிர்மெய் வரிசைகள் நீக்கப்பட்டபின் இப்போது நீங்கள் பார்ப்பது யப்பானிய மொழியின் அடிப்படை அட்டவணை.\n
    ஆனால் இவை இறுதியான ஒலி அட்டவணை என்று அர்த்தமாகாது, இன்னும் சில மாற்றங்கள் இருக்கின்றன. தமிழ் மொழி போலவே யப்பானிய மொழியிலும் சில உச்சரிப்பு மாற்றங்கள் நிகழ்ந்துள்ளன. அவற்றை அடுத்துவரும் படிநிலைகளில் சுருக்கமாகக் காணலாம்.\n
    இப்போது, நீங்கள் "க ச த ந ப ம ய ர வ ன" என்ற வரிசையை படித்துப் பாருங்கள். தமிழைக்காட்டிலும் எளிமை தானே?\n
    முன் சொன்னவாறு இந்த "ர" வரிசையானது சிலசமயம் "ல" போலும் சிலசமயம் "ர" போலும் நமக்கு கேட்கும், இரண்டு உச்சரிப்புகளும் கலந்தே உள்ளன எனலாம். அதனாலேயே மொழியியலில் இந்த வரிசை "Liquid Sound" அல்லது "திரவ ஒலி" எனப்படுகிறது.`,
    summary: 'படிநிலை-5: அடிப்படை அட்டவணை தயார்.',
  },

  {
    label: 'ஒற்றுகள் தேவையா?',
    note: `    தமிழில் மெய் ஒலிகளுக்கென்று புள்ளியிட்ட வரிவடிவங்கள் இருக்கின்றன ஆனால் எல்லா மொழிகளுக்கும் அப்படி இல்லை. உதாரணமாக மலையாளம், கன்னடம் மற்றும் தெலுங்கு ஆகிய மொழிகளில் மெய் ஒலிகள் இருந்தாலும் அவற்றை எழுதும் விதம் வேறு. அதேபோல யப்பானிய மொழியும் மெய் ஒலிகளை எழுத வித்தியாசமான ஒரு முறையை கையாள்கிறது அவற்றை சுருக்கமாக கீழே காணலாம்:\n
    <b>க், ச், த், ப்:</b>
    இம்மெய் ஒலிகள் யப்பானிய மொழியிலும் இருக்கின்றன, ஆனால் இவற்றை எழுத தனித்துவமாக ஒரு முறையை கையாள்கிறது அதுகுறித்துப் பின்னர் பார்க்கலாம்.\n
    <b>ந், ம்: </b>
    இம்மெய் ஒலிகள் யப்பானிய மொழியில் முன்னர் பார்த்த 'ங்', 'ஞ்' போலவே 'ன்' என்ற எழுத்தையே ஏற்றுக் கொள்கின்றன, 'தந்தம்' என்பதை 'தன்தம்' என்றும், 'அம்மா' என்பதை 'அன்மா' என்றும் எழுதுவதைப் போல. தமிழில் 'ம்' ஒலி சொல்லின் இறுதியிலும் வரும் ஆனால் யப்பானிய மொழியில் அப்படி இல்லை. ஆக இவ்விரு ஒலிகளுக்கு தனியே வரிவடிவம் இல்லை.\n
    <b>ய், ர், வ்: </b>
    இம்மெய் ஒலிகளைக் கொண்ட யப்பானியச் சொற்களே கிடையாது, ஆகவே இவற்றிற்கும் வரிவடிவம் இல்லை`,
    summary: 'படிநிலை-6: மெய்யெழுத்துக்கள் எங்கே?',
  },

  {
    label: 'ன் எனுஞ்சிறப்பு ஒலி',
    note: `    சென்ற படிநிலையில் 'ந்' ஒலியை 'ன்' கொண்டே எழுதுகிறார்கள் என்று பார்த்தோம், மாற்றாக 'ன்' வரிசையிலுள்ள "ன னி னு னெ னொ" விற்கு பதில் யப்பானிய மொழியில் ஏற்கனவே உள்ள "ந நி நு நெ நொ" ஒலிகளையே பயன்படுத்துகிறார்கள்.\n
    ஆக கடைசி 'ன்' வரிசையின் உயிர்மெய் ஒலிகளின் தேவை இல்லாததால் அவ்விடத்தை 'ன்' எனும் மெய் மட்டும் எடுத்துக்கொள்கிறது. இந்த "ன்" ஒலிக்கு யப்பானிய மொழியில் "ஹட்சுஓன்" என்று பெயர், அப்படியென்றால் "மூக்கொலி", மூக்கிலிருந்து பிறக்கும் ஒலி எனப்பொருள் கொள்ளலாம்.\n
    இதனை, "தனிஒலி" அல்லது "சிறப்புஒலி" என்றும் வழங்குவர், ஏனெனில் இது ன், ம், ங் போன்ற பல ஒலிகளை தன்னகத்தேக் கொண்டது.\n
    இன்னும் சொல்லப்போனால், தமிழின் மொத்த மெல்லின ஒலிகலாகிய "ங் ஞ் ண் ந் ம் ன்" எல்லாவற்றிக்கும் யப்பானிய மொழியின் இந்த ஒரே எழுத்தை பயன்படுத்த முடியும் என்றால் இது சிறப்பான எழுத்து தானே?.`,
    summary: 'படிநிலை-7: "ன்" எனும் சிறப்பெழுத்து',
  },

  {
    label: 'சி அது ஷி ஆதல்',
    note: `    'சி' ஆனது 'ஷி' என மாற்றமடைந்து இருப்பதை இங்கே பார்க்கலாம்.\n
    வரிவடிவம் கால ஓட்டத்தில் மாற்றம் அடைவது நாம் அறிந்தது, அதனைப் போலவே ஒலிவடிவமும் மாற்றமடைவது உண்டு. ஒருவர் உச்சரிக்கும் ஒலிக்கும் இன்னோருவர் உச்சரிக்கும் ஒலிக்குமே வித்தியாசம் இருக்கும் பொழுது, பலநூறு ஆண்டுகளாக மக்கள் இடப்பெயர்வு, கலாச்சார பரிமாற்றம், வணிகத் தொடர்பு போன்ற காரணிகளால் ஒலியின் உச்சரிப்பிலும் பல்வேறு மாற்றங்கள் நிகழ்வது இயல்பு.\n
    தமிழிலும் கூட, இந்த 'ச' வரிசையானது 'ச்ச', 'ச்சி'.. என்றே பழந்தமிழில் உச்சரிக்கப்பட்டுவந்திருக்கிறது, கால மாற்றத்தில் நாம் இன்று 'ஸ', 'ஸி'.. என்று இவற்றை வாசிக்கிறோம். "சோழன்" என்று எழுதி அதை நாம் "ஸோழன்" என்று உச்சரிக்கிறோம், இது தவறு. "ச்சோழன் " என்று உச்சரிப்பாதே சரி. எனினும் இந்த மாற்றங்கள் மொழியின் இருத்தலில் தவிர்க்க முடியாதது.\n
...

  {
    ...
    note: `    தமிழின் இன்றைய "சி" யானது ஒரு காலத்தில் "ச்சி" என்றே உச்சரிக்கப்பட்டது என்று சென்ற படிநிலையில் பார்த்தோமல்லவா? போலவே யப்பானிய மொழியிலும் "ச்சி" அது "சி" ஆகி பின் "ஷி" என்று மாறியிருக்குமேயாயின், பிற்காலத்தில் "தி" எனும் ஒலியின் தேவை குறைந்து 'த' வரிசையின் "தி" யானது "ச்சி" என்று உருமாற்றமடைந்திருக்கலாம்.\n
    என் தெலுங்கு நண்பர்கள் சிலர் "நித்தியா" என்ற பெயரை "நிச்சியா" என்று உச்சரிப்பர், மொழியியலில் இதை palatalization என்கிறார்கள், இது இயல்பான ஒரு ஒலிமாற்றம்.\n
    எப்படியோ யப்பானிய மொழியில் 'தி' ஆனது 'ச்சி' என்றாகிருக்கிறது, இதன் காரணகாரணிகளுக்குள்ளே போகவேண்டாம், அதை அதன்படியே எடுத்துக்கொள்வது நன்று.`,
...

  {
    ...
    நா அடிப்படையில் தொண்டைக்கு மேல் தொடும் ஒலி 'த்' ஆனது  இயல்பான ஒலி மாற்றம் அடைந்து ஈரிடஒலி 'ட்சு' (முதலில் 'த்',பின் 'ஸ்') என்று மாற்றமடைந்துள்ளதாக மொழியியலாளர்கள் கருதுகின்றனர், இதனை affrication என்பர்.\n
    என்றாலும் மறுபடியும் சொல்கிறேன் இதன் காரணகாரணிகளுக்குள்ளே போகவேண்டாம், அதை அதன்படியே எடுத்துக்கொள்வது நன்று`,
...

  {
    ...
    இம்மொழியியல் காரணி அடிப்படையில் யப்பானிய மொழியில் வல்லொலி வரிசை "ப, பி, பு, பெ, பொ" ஆனது மெல்லொலி வரிசை "ஹ, ஹி, ஹு, ஹெ, ஹொ" என்றாகிருக்கிறது.`,
    summary: 'படிநிலை-11: உச்சரிப்பு மாற்றம் (ப வரிசை -> ஹ வரிசை)',
  },

  {
    label: 'ஃபு அல்லது ஹு',
    note: `    வல்லொலி ஒன்று மெல்லொலியாக மாறுவதற்கு நடுவில் இடைநிலைஒலி என்ற ஒன்றை அடைகிறது அது "உராய்வுஒலி" என்றும் வழங்கப்படுகிறது. இதன்படி யப்பானிய 'ப' வரிசை 'ஹ' வர்சையாக மாறுவதர்கு முன்னர் 'ஃப' எனும் வரிசையாக மாறியிருக்கிறது.\n
    அதாவது "ஃப, ஃபி, ஃபு, ஃபெ, ஃபொ" என்று மாறியிருக்கிறது, இதிலிருந்து ஹ வரிசைக்கு மாறும்பொழுது "ஃபு" மட்டும் அப்படியே நிலைத்து விட்டது என்று கொள்ளலாம். மேலும் நன்கு கவனித்தீர்கள் என்றால், இந்த "ஃபு" ஆனது "ஹு" என்றும்கூட கேட்கும். யப்பானியர் "ஃபுஜி" என்று உச்சரிக்கையில் அது "ஹுஜி" என்றும் கேட்கலாம், அவ்வளவு மெல்லிய வித்தியாசம்தான் இருக்கிறது இந்த இரண்டு ஒலிக்கும்.\n
    ஒன்றை கவனித்தீர்களா? இந்த 'fu' எனும் ஒலியை நாம் எளிமையாக 'ப' முன் 'ஃ' என்ற ஆய்த எழுத்தைச் சேர்த்து வாசிக்கிறோம் ஆனால் தொல்தமிழ் இலக்கணப்படி இப்படி பயன்படுத்த இயலாது எனினும், பா.வே. மாணிக்கனார் போன்ற தமிழ் அறிஞர்கள் வேற்று மொழி ஒலிகளை நாம் தனிஎழுத்து 'ஃ' கொண்டு உச்சரிக்க முடியும் என்று பல்வேறு முறைகளை முன்மொழிந்துள்ளனர், அவற்றை நாம் முழுமையாக கையாளவில்லை என்றாலும் 'f' ஒலிக்கு நாம் உபயோகப்படுத்துவதைப் பார்க்கையில் காரணம் கருதிதான் இதற்கு "தனிஎழுத்து" என்று பெயரிட்டனரோ என்று தோன்றுகிறது.`,
...

  {
    ...
    அல்லது இந்த "யி" மற்றும் "யெ" ஒலிகளை "இ" மற்றும் "எ" கொண்டே எழுதி உச்சரிக்கின்றனர் எனக்கொள்ளலாம்.\n   
    தமிழிலும் கூட,
        "வாயில்" என்பதை "வாஇல்" என்றும்,
        "கடையெழு" என்பதை "கடைஎழு' என்றும் எழுதி வாசிக்க முடியுமல்லவா? அதுபோல.`,
    summary: 'படிநிலை-13: யியும் யெயும், இயும் எயுமாய் இருத்தல்',
  },

  {
    label: 'ஈரொலி குறைந்த அட்டவணை',
    note: `    இப்பொழுது 'க' துவங்கி 'ய' வரிசை வரை ஒருமுறை வாசித்துப்பாருங்கள், முடிந்தால் ஒரு பாடல் போல கூட பாடிப்பருங்கள்\n
    "க ச த ந - ஹ ம ய" இதையே மீண்டும் மீண்டும் படித்து மனப்பாடம் செய்து பாருங்கள் எளிமையாக மனதில் பதிந்து விடும்`,
    summary: 'படிநிலை-14: யி மற்றும் யெ ஒலிகளின் மதிப்புகளை நீக்கு',
  },

  {
    label: 'வியும் வுவும் வெவும், இயும் உவும் எவுமாய் இருத்தல்',
    note: `    "வ வி வு வெ வொ" எனும் வரிசையில் 'வு' வையும் உயிர் 'உ' கொண்டே உச்சரிக்கலாம் தானே?, இந்த வெளிப்படையான காரணத்திற்காகவே யப்பானியர்கள் இந்த 'வு' வை 'வ' வரிசையிலிருந்து நீக்கியிருக்கின்றனர்.\n
    தமிழிலும் கூட,
        "கடவுள்" என்பதை "கடஉள்" என்றும்,
        "பரப்பளவு" என்பதை "பரப்பளஉ' என்றும் எழுதி வாசிக்க முடியும் அல்லவா? அதுபோல.\n
    மேலும், 'வி', 'வெ' ஒலிகளைப்பொருத்தமட்டில், பல நூற்றாண்டுகளுக்கு முன்னரே இவற்றிலிருந்து 'வ்' எனும் மெய்ஒலி நீங்கி, 'இ' மற்றும் 'எ' என்றே வழங்கப்படலாயிற்று.\n
    பழைய யப்பானிய மொழியிலேயே "விரு" எனுஞ்சொல், "இரு" என மாற்றமடைந்திருக்கிறது, போலவே "வெ" எனுஞ்சொல், "எ" என மாற்றமடைந்திருக்கிறது. யப்பானிய மொழியில் "இரு" என்றால் "இருத்தல்", "எ" என்றால் "படம்/ஓவியம்".\n
    ஏற்கனவே உயிர் வரிசையில் 'இ'யும், 'எ'வும் இருப்பதால், வ வரிசையிலிருந்து இவ்விரு ஒலிகளும் நீக்கப்பட்டுவிட்டன.`,
    summary: 'படிநிலை-15: வியும் வுவும் வெவும், இயும் உவும் எவுமாய் இருத்தல்',
  },

  {
    label: 'மூவொலி குறைந்த அட்டவணை',
    note: `    இப்பொழுது 'க' துவங்கி 'ன்' வரிசை வரை ஒருமுறை வாசித்துப்பாருங்கள், முடிந்தால் ஒரு பாடல் போல கூட பாடிப்பருங்கள்\n
    "க ச த ந - ஹ ம ய - ர வ ன" இதையே மீண்டும் மீண்டும் படித்து மனப்பாடம் செய்து பாருங்கள் தமிழின் வரிசையை விட எளிமையாக மனதில் பதிந்து விடும்`,
...

  {
    ...
    தொல்காப்பியர் அகரம் முதல் னகரம் வரை 30 எழுத்துக்கள் என்பார், யப்பானிய மொழியில் அதே அகரம் முதல் னகரம் வரை 46 எழுத்துக்கள் எனலாம். யப்பானிய மொழியில் இந்த 46 எழுத்துகளை "அடிப்படை எழுத்துகள்" என்பர், இன்னும் பல ஒலிகள் யப்பானிய மொழியில் உள்ளன, என்றாலும் வரிவடிவங்கள் இவ்வளவுதான், இவற்றை வைத்துத்தான் இன்ன பிற ஒலிகளையும் எழுதுகின்றனர். இது குறித்து பின்னர் விரிவாகவும் எளிமையாகவும் பார்க்கலாம்.\n
    நான் கையாண்ட இந்த முறையை வைத்து, தமிழிலிருந்துதான் யப்பானிய மொழி பிறந்தது என்று கருதுவது கூடாது. அப்படிக் கருதுவோமாயின் அது இவ்விரு மொழிகளுக்கும் நாம் செய்யும் அறமற்ற செயல்.\n
    யப்பானிய மொழியைக் கற்கத் தொடங்கியதிலிருந்து இவ்விரு மொழிகளுக்கிடையே நான் காணும் ஒற்றுமைகள் என்னை மீண்டும் தமிழ் மாணவனாக மாற்றியிருக்கிறது, மேலும் அது என் யப்பானிய மொழி கற்றல் பயணத்தை எளிமையாகவும் மாற்றியிருக்கிறது. எனவே, என்னைப் போலவே தமிழ் வழி யப்பானிய மொழியைக் கற்பவர்களுக்கு இக்கருவி பயன்படும் என நினைக்கிறேன்.`,
    summary: 'படிநிலை-17: இறுதி நிலை',
  },

  {
    label: 'கிஹொன்-ஒன்',
    note: `    இது இறுதி நிலை. தமிழ்-யப்பானிய ஒலிப் பயணம் முற்றிற்று. இப்போது உங்களுக்கு யப்பானிய அடிப்படை உச்சரிப்பு தெரியும் என்பதால் யப்பானிய வரிவடிவம் கொண்ட இந்த அறிச்சுவடியைப் பார்த்து ஒருமுறை வாசித்துப்பாருங்கள்.\n
    இப்போது நீங்கள் பார்ப்பது, யப்பானிய மொழியில் மூன்று வரிவடிவங்களுள் ஒன்றான "ஹிரகந". இதைத்தான் யப்பானியக் குழந்தைகள் முதலில் படிக்கின்றனர். இன்னும் "கதகந" மற்றும் "கான்ஜி" என இரு வரிவடிவங்கள் உள்ளன. இவையெல்லாம் கற்க இன்னும் சுவையாக இருக்கும், இதுகுறித்து அடுத்தடுத்து விரிவாகப்பார்க்கலாம்.\n
