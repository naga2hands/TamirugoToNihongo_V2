...
'末 - இறுதி / முடிவு'
    ...
    },
    {
      ...
      color: '#f59e0b',
      samples: [
        '明 - வெளிச்சம்  (சூரியன் + நிலவு)',
'森 - காடு (மரம் + மரம் + மரம்)',
'林 - சிறுகாடு (மரம் + மரம்)',
'炎 - தீப்பொறி  (தீ + தீ)',
'男 - ஆண் (வயல் + ஆற்றல்)',
'休 - ஓய்வு மனிதன் + மரம்)',
'信 - நம்பிக்கை / விசுவாசம் (மனிதன் + சொல்)',
'好 - விருப்பம் (பெண் + குழந்தை)'
      ],
    ...
    },
    {
      ...
      color: '#ef4444',
      samples: [
        '河 - நதி (நீர் + உச்சரிப்பை சுட்டும் கூறு)',
'校 - பள்ளி (மரம் + உச்சரிப்பை சுட்டும் கூறு)',
'語 - மொழி/சொல் (பேச்சு + உச்சரிப்பை சுட்டும்)',
'清 - சுத்தம்/தெளிவு (நீர் + உச்சரிப்பை சுட்டும் கூறு)',
'海 - கடல் (நீர் + உச்சரிப்பை சுட்டும் கூறு)',
'橋 - பாலம் (மரம் + உச்சரிப்பை சுட்டும் கூறு)',
'銀 - வெள்ளி (உலோகம் + உச்சரிப்பை சுட்டும் கூறு)',
'電 - மின்னல் (மழை + உச்சரிப்பை சுட்டும் கூறு)'
      ],
    ...
    },
    {
      ...
      color: '#8b5cf6',
      samples: [
        '楽 - (பொருள் திரிபு: இசை → மகிழ்ச்சி)',
'長 - (பொருள் திரிபு: நீளம் → தலைவன்)',
'考 - (பொருள் திரிபு: முதுமை → சிந்தி)',
'悪 - (பொருள் திரிபு: கெடு → தீமை)',
'労 - (பொருள் திரிபு: களைப்பு → முயற்சி)',
'自 - (பொருள் திரிபு: மூக்கு → சுயம்)'
      ],
    ...
    },
    {
      ...
      color: '#06b6d4',
      samples: [
        '我 - (உச்சரிப்பு: வ; பொருள்: ஆயுதம் → என்னை)',
'来 - (உச்சரிப்பு: ரை; பொருள்: தானியம் → வருதல்)',
'七 - (உச்சரிப்பு: ஷிச்சி; பொருள்: வெட்டு → ஏழு)',
'豆 - (உச்சரிப்பு: தோ; பொருள்: பாத்திரம் → பயறு)',
'東 - (உச்சரிப்பு: தோ; பொருள்: மூட்டை → கிழக்கு) ',
'求 - (உச்சரிப்பு: வ; பொருள்: தோலாடை → தேடு)'
      ],
